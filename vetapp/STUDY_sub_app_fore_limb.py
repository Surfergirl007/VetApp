...
class Bone_Object():
    ...
    def load_data(self, ren, balloonWidget, stl_name):
        ...
        my_bone_actor, balloonWidget = polyDataToActor(polydata, balloonWidget, self.__name)
        ren.AddActor(my_bone_actor)
        # print('my_actor:', my_bone_actor, self.__name)
        self.__actor = my_bone_actor
        return ren, reader, balloonWidget
...
def polyDataToActor(polydata, balloonWidget, name):
    ...
    #caption.SetCaption("This is a test\nAnd it has two lines")
    ...
    return bone_actor, balloonWidget

"""def get_user_input_name(clean_name):
    user_input =''
    while user_input != clean_name:
        user_input = input('Bitte benennen Sie diesen Knochen')
...
def main():
    ...
    for name, bone_object in bone_objects.items():
        #print(bone_object)
        ren, reader, balloonWidget = bone_object.load_data(ren, balloonWidget, name)
    #iren.Initialize()
